...
class UppaalQueryGenerator {
	def static String generateUpaalQueryShort(List<CraneS> cranes, List<DiskS> discs, List<CameraS> cameras){
		return '''
			<queries>
			    «FOR crane: cranes»
				<query>
	...
	def static String generateUpaalQueryLong(List<Crane> cranes, List<Disk> discs, List<Camera> cameras){
		return '''
			<queries>
			    «FOR crane: cranes»
			    <query>
