 ...
 *   <li>{@link xtext.factoryLang.shortDSL.shortDSL.ConditionS#getValue <em>Value</em>}</li>
...
public interface ConditionS extends StatementS
{
   ...
   * @see #setValue(Value)
   * @see xtext.factoryLang.shortDSL.shortDSL.ShortDSLPackage#getConditionS_Value()
  ...
  /**
   * Sets the value of the '{@link xtext.factoryLang.shortDSL.shortDSL.ConditionS#getValue <em>Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
